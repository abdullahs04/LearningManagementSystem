...
const TimeTableProfessor: React.FC = () => {
  const [scheduleItems] = useState<TimetableEntry[]>([
    ...
    },
    {
      ...
      extendedProps: {
        courseCode: "MEET",
        courseTitle: "Department Meeting",
  ...
  return (
    <>
      <PageMeta
        title="Professor Timetable | Learning Management System"
        description="Professor teaching schedule showing lectures, labs, office hours and meetings"
      />
      <div className="rounded-2xl border border-gray-200 bg-white dark:border-gray-700 dark:bg-gray-800 shadow-sm p-4 md:p-6">
        <div className="flex flex-col md:flex-row gap-6">
          ...
          <div className="md:w-1/3 lg:w-1/4">
            <h2 className="text-xl font-semibold mb-4 text-gray-800 dark:text-gray-100">Today's Teaching Schedule</h2>
            {todayItems.length > 0 ? (
                ...
                {todayItems.map((item) => (
                  ...
                  >
                    ...
                    <div className="mt-2 flex justify-between text-xs">
                      <span>Location: {item.extendedProps.location}</span>
                      {item.extendedProps.numberOfStudents > 0 && (
                        <span>Students: {item.extendedProps.numberOfStudents}</span>
                      )}
                    </div>
                  </div>
                ))}
              ...
              <div className="bg-gray-50 dark:bg-gray-700/50 rounded-lg p-4 text-center">
                <p className="text-gray-600 dark:text-gray-300">No teaching commitments scheduled for today</p>
              </div>
            )}
          </div>
                ...
                eventContent={(eventInfo) => {
                  ...
                  return (
                    <div className="p-1 h-full">
                      ...
                      <div className="text-xs mt-1 opacity-80">{event.extendedProps.location}</div>
                    </div>
                  );
                }}
              />
...
export default TimeTableProfessor;