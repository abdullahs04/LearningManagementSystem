...
// TODO fix the UI inconsistency and remaining issues i left, have to run again.
...
export default function Grading() {
      ...
      assignments: [
        ...
        { 
          ...
          students: [
            ...
            { id: 3, name: "Charlie Davis", submitted: true, submissionDate: "2023-11-05", grade: null, feedback: "Needs improvement in time complexity." },
  ...
  // Function to calculate graded rate
  const getGradedRate = (assignment: Assignment): number => {
    return Math.round((assignment.graded / (assignment.submitted || 1)) * 100);
  };

  // Function to get submission status badge
  const getSubmissionStatusBadge = (student: Student) => {
      ...
      <div className="space-y-6">
        ...
        <div className="overflow-hidden rounded-lg border border-gray-200 dark:border-gray-700">
          <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
            <thead className="bg-gray-50 dark:bg-gray-800">
              <tr>
                <th scope="col" className="px-6 py-3 text-left text-xs font-medium uppercase tracking-wider text-gray-500 dark:text-gray-400">Assignment</th>
                <th scope="col" className="px-6 py-3 text-left text-xs font-medium uppercase tracking-wider text-gray-500 dark:text-gray-400">Due Date</th>
                <th scope="col" className="px-6 py-3 text-left text-xs font-medium uppercase tracking-wider text-gray-500 dark:text-gray-400">Points</th>
  ...
  const renderStudentSubmissions = () => {
    if (!selectedAssignment || !selectedCourse) return null;
